...
class Navbar extends Component {
    ...
    componentDidUpdate() {
        ...
        if (this.overLay.current !== null) {
            ...
            TweenMax.from(
                this.infoContainerMain.current,
                0.5,
                {
                    opacity: 0.2,
                    y: 20,
    ...
    render() {
        ...
        const overlayMenu = (
            <div ref={this.overLay} className='overlay-menu'>
                <button ref={this.close} className='close-btn' onClick={this.props.toggleMenu}>
                    <img id='close-icon' src={CloseIcon} />
                </button>
                <div ref={this.linkContainer} className='link-container'>
                    <Link to='/'><h5 ref={this.overLayShop} onClick={this.props.toggleMenu}>Gallery</h5></Link>
                    <Link to='/shop'><h5 ref={this.overLayStuff} onClick={this.props.toggleMenu}>Shop</h5></Link>
                    <Link to='/about'><h5 ref={this.overLayContact} onClick={this.props.toggleMenu}>About</h5></Link>
                    <Link to='/contact'><h5 ref={this.overLayAbout} onClick={this.props.toggleMenu}>Contact</h5></Link>
                </div>
                <div ref={this.infoContainerMain}>
                    ...
                    <div className='info-container-main reimagined'>
                        <a
                            ...
                            <img id='pinterest-icon' class='social-media' src={PinterestIcon} />
                        </a>
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                            ...
                            className='social-media-a'>
                            <img id='insta-icon' class='social-media' src={InstaIcon} />
                        </a>
                        <a
                            target="_blank"
                            rel="noopener noreferrer"
                            ...
                            className='social-media-a'>
                            <img id='rb-icon' class='social-media' src={RBIcon} />
                        </a>
                    </div>
                </div>
            </div>
        ...
        const searchMenu = (
            <div ref={this.overLaySearch} className='overlay-menu'>
                <div className='search-flex'>
                    <button className='close-btn-search' onClick={this.props.toggleSearchMenu}>
                        <img id='close-icon' src={CloseIcon} />
                    </button>
                </div>
                <div className='search-container'>
                    <input ref={this.searchInput} className='search-input' placeholder="Search..." />
                    <button className='searchmenu-btn' >
                        <img id='searchmenu-icon' src={SearchIconWhite} />
                    </button>
                </div>
            </div >
        )
            ...
            <div className='position'>
                ...
                <div id='top-container'>
                    <div className="cart-badge-container">
                        <Link to='/cart'>
                            <img className='cart-icon' src={CartIcon2} />
                    ...
                    {localStorage.getItem('_shpuid') ?
                        (this.props.loading ? loader2 : <Link onClick={this.props.authSignOut} className='top-container-link-margin'>Sign Out</Link>)
                        : <Link className='top-container-link-margin' to='/signin' >Sign In</Link>}
                ...
                <nav className='nav-container' >
                    <div className='logo-ham-container'>
                        <button className='icon-btn' id='Hamburgur' onClick={this.props.toggleMenu}>
                            <img id='ham-icon' src={HamIcon} />
                        </button>

                        <Link id='logo-sm' onClick={this.props.setTitle} to='/'><p className='logo'>Pattterns</p></Link>
                        ...
                        <button className='icon-btn' onClick={this.props.toggleSearchMenu}>
                            <img className='search-icon' id='s1' src={SearchIcon} />
                        </button>
                    </div>

                    <ul className='nav'>
                        <Link id='logo-link' onClick={this.props.setTitle} to='/'><p className='logo'>Pattterns</p></Link>
                        <div className="navigation-menu">
                            ...
                            <button className='icon-btn' onClick={this.props.toggleSearchMenu}>
                                <img className='search-icon' id='s2' src={SearchIcon} />
                            </button>
                        </div>
