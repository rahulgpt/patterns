...
import { checkoutURL, paymentIntentURL } from '../../constants';
...
class CheckoutForm extends Component {
    ...
    render() {
        ...
        const { isProcessing, checkoutError } = this.state;
        return (
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className='billing-details'>
                        ...
                        <h5>
                            ...
                            <div class="more-info">
                                ...
                                <Popup
                                    ...
                                    link={<a target="_blank" rel="noopener noreferrer" href='https://support.stripe.com/questions/requirements-for-india-export-charges'> More information</a>}
                                />
                        ...
                        <label id='billing-name'>
                            Name
                            <input type='text' name='billing-name' className='checkout-input' onChange={this.handleInputChange} />
                        </label>

                        <label id='billing-email'>
                            Email
                            <input type='email' name='billing-email' className='checkout-input' onChange={this.handleInputChange} />
                        </label>

                        <label id='billing-state'>
                            State
                            <input type='text' name='billing-state' className='checkout-input' onChange={this.handleInputChange} />
                        </label>

                        <label id='billing-city'>
                            City
                            <input type='text' name='billing-city' className='checkout-input' onChange={this.handleInputChange} />
                        </label>

                        <label id='billing-address'>
                            Address
                            <input type='text' name='billing-address' className='checkout-input' onChange={this.handleInputChange} />
                        </label>

                        <label id='billing-zip'>
                            ZIP
                            <input type='text' name='billing-zip' className='checkout-input' onChange={this.handleInputChange} />
                        </label>

                        <label id='billing-remember'>
                            Remember Billing Details
                            <input type='checkbox' name='billing-remember' defaultChecked='true' onChange={this.handleInputChange} />
                        </label>
