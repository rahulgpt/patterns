                ...
                <div className='dashboard'>
                    ...
                    <div className='nav-detail'>
                        <div className='dashboard-item'>
                            <span className='grp'>
                                <img className='product-img' src={dummyImage} alt='product-img' />
                                <h3 className='p-title'>Bats and Bunting</h3>
                            </span>

                            <button className='auth-btn reg-btn download-btn'>Download</button>
                        </div>
                        <div className='dashboard-item'>
                            <span className='grp'>
                                <img className='product-img' src={dummyImage1} alt='product-img' />
                        ...
                        <div className='dashboard-item'>
                            <span className='grp'>
                                <img className='product-img' src={dummyImage2} alt='product-img' />
