        ...
        return (
            <div className='contact-container'>
                ...
                <div className='form-wrapper'>
                    <p className='contact-line'>If you want to have a custom pattern or illustration or want to work together on a project,  send a message below.
                    I am excited to have projects where I can put my work to great use. Let’s create something amazing!</p>
                    <form>
